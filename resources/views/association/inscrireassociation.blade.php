            ...
            <form action="{{ route('register') }}" method="POST" class="registration-form">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="nom" name="nomassociation" required placeholder=" ">
                    </div>
                    <div class="form-group">
                        <label for="emailassociation">Email *</label>
                        <input type="text" id="email" name="emailassociation" required placeholder=" ">
                    </div>
                    <div class="form-group">
