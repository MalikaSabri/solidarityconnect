...
<head>
    ...
    <title>SolidarityConnect - Accorder Association</title>
    ...
    <style>
        ...
        :root {
            ...
            --color-soft-blue-button: #BFDBFE; /* "Accorder" button background */
        ...
        .associations-table thead th:first-child {
            border-top-left-radius: 10px;
        }
        .associations-table thead th:last-child {
        ...
        .associations-table tbody td:first-child {
            border-top-left-radius: 10px;
            border-bottom-left-radius: 10px;
        }
        .associations-table tbody td:last-child {
            border-top-right-radius: 10px;
    ...
    font-weight: bold;
      ...
      .profile-avatar {
        ...
        @media (max-width: 480px) {
            ...
            /* Stack table columns or allow horizontal scroll on very small screens */
            .associations-table {
                display: block;
                overflow-x: auto;
                white-space: nowrap;
            }
            .associations-table thead, .associations-table tbody, .associations-table tr {
                display: inline-block;
                vertical-align: top;
            }
            .associations-table th, .associations-table td {
                display: block;
                text-align: center;
                width: 150px; /* Fixed width for columns */
                box-sizing: border-box;
            }
            .associations-table th:first-child, .associations-table td:first-child { text-align: left; }
            .associations-table th:last-child, .associations-table td:last-child { text-align: right; }
        }
    </style>
</head>
<body>
...
<div class="left-panel">
    ...
    <a href="{{ route('don.historique') }}" class="btn-retour">Retour</a>
</div>
...
<tr>
    <td>{{ $association->nom_complet }}</td>
    <td>{{ $association->description }}</td>
    <td>{{ $association->telephone }}</td>
    <td>
        <form action="{{ route('don.accorder') }}" method="POST">
            @csrf
            <input type="hidden" name="donation_id" value="{{ $donation->id }}">
            <input type="hidden" name="association_id" value="{{ $association->id }}">
            <button type="submit" class="action-button">Accorder</button>
        </form>
    </td>
</tr>
@endforeach
